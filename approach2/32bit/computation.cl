                                ...
                                )
{
    ...
    __private ulong lshift = 2;
    __private ulong rshift = 7;
   ...
   // blocksize = 32;
    ...
    // go over all rounds
    for(__private uint round=1; round <= 22; round++)
    {
                                        ...
                                        )
{
    ...
    size_t gidDim2 = get_global_id(1); // work item number
		...
		/*
	    if ( (gidDim1 > 26334) || (gidDim2 > 26334)    ) 
	    {
    ...
    else
    {
        ...
        __private ulong rounds = 22;
        __private ulong blocksize = 32;
