...
void::heuristic_lib::Heuristic::runCipher()
{
	...
	cl_ulong blocksize = 16; 
	cl_ulong counter = 0;                         
		
	/*
	printBinary(getHexBit64[0] , blocksize); cout << endl;
	printBinary(getHexBit64[1] , blocksize); cout << endl;
	printBinary(getHexBit64[2] , blocksize); cout << endl;
	printBinary(getHexBit64[3] , blocksize); cout << endl;
	printBinary(getHexBit64[4] , blocksize); cout << endl;
*/

	cout << "Start generating input data " << endl;
	//cl_ulong blocksize = 0xffff; 	     
    ...
    //create masks
	/*
	for (cl_ulong i1=i0;i1<blocksize;i1++)
	{//i1*****************************************
   ...
   */
	...
	{
		printBinary(inputData[test], 16 ); cout << endl;
