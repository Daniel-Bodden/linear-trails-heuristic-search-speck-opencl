 ...
 */
 ...
 //===============================================================
 //CALCULATE BIAS COUNT BY CALCULATING HAMMINGWEIGHT DIVIDED BY 2
 inline ulong biascount(   
	 						__private  ulong mask)
 {
     __private  ulong value = 0;
	 
	 //bias count is hammingweight divided by 2
                                ...
                                )
{
        ...
        //initalize
        for (__private uint round = 0; round < 22; round++)
        {
        ...
        for(__private uint round = 1; round<=23;round++) // SPECK HAS 22 ROUNDS
        {
            ...
            //Check UpperBoundLimit
	         /**/
            else if (checkUpperBound(   count + 
										biascount((rotate_right(inputMaskX,rshift,wordlength))),blocksize)
										==true)
            {
                //STOP CURRENT ITERATION
                break;
        ...
        for(__private uint round = 1; round <= 23 ;round++) // SPECK HAS 22 ROUNDS
        {
            ...
            //Check UpperBoundLimit
            /*    */
	 	   else if (checkUpperBound(
			   						count + biascount((inputMaskX ^ inputMaskY)), blocksize)
									==true)
            {
                //STOP CURRENT ITERATION
                break;
