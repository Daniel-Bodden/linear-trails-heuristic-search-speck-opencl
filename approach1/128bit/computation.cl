 ...
 */
 ...
 inline ulong biascount(   __private  ulong mask)
 {
                                ...
                                )
{
        ...
        //initalize
        for (__private uint round = 0; round < 32; round++)
        {
        ...
        __private ulong count = 0;
        __private ulong wordlength= 64;  //divided by the number of words in the round function
