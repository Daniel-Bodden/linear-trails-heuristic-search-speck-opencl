...
void::heuristic_lib::Heuristic::runCipher()
{
	...
	//cl_ulong blocksize = 0xffffffffffffffff; 	        
	...
	for (cl_ulong i9=(blocksize/2)-9;i9<(blocksize/2)-8;i9++)
	{//i9
		
	for (cl_ulong i10=(blocksize/2)-10;i10<(blocksize/2)-9;i10++)
	{//i10
							
	for (cl_ulong i11=(blocksize/2)-11;i11<(blocksize/2)-10;i11++)
	{//i11
	
	for (cl_ulong i12=(blocksize/2)-12;i12<(blocksize/2)-11;i12++)
	{//i12	
	
	for (cl_ulong i13=(blocksize/2)-13;i13<(blocksize/2)-12;i13++)
	{//i13
		
	for (cl_ulong i14=(blocksize/2)-14;i14<(blocksize/2)-13;i14++)
	{//i14
							
	for (cl_ulong i15=(blocksize/2)-15;i15<(blocksize/2)-14;i15++)
	{//i15
	
	for (cl_ulong i16=(blocksize/2)-16;i16<(blocksize/2)-15;i16++)
	{//i16
		
	for (cl_ulong i17=(blocksize/2)-17;i17<(blocksize/2)-16;i17++)
	{//i17
		
	for (cl_ulong i18=(blocksize/2)-18;i18<(blocksize/2)-17;i18++)
	{//i18
							
	for (cl_ulong i19=(blocksize/2)-19;i19<(blocksize/2)-18;i19++)
	{//i19
	
	for (cl_ulong i20=(blocksize/2)-20;i20<(blocksize/2)-19;i20++)
	{//i20	
	
	for (cl_ulong i21=(blocksize/2)-21;i21<(blocksize/2)-20;i21++)
	{//i21
		
	for (cl_ulong i22=(blocksize/2)-22;i22<(blocksize/2)-21;i22++)
	{//i22
							
	for (cl_ulong i23=(blocksize/2)-23;i23<(blocksize/2)-22;i23++)
	{//i23
	
	for (cl_ulong i24=(blocksize/2)-24;i24<(blocksize/2)-23;i24++)
	{//i24
		
	for (cl_ulong i25=(blocksize/2)-25;i25<(blocksize/2)-24;i25++)
	{//i25
	
	for (cl_ulong i26=(blocksize/2)-26;i26<(blocksize/2)-25;i26++)
	{//i26
		
	for (cl_ulong i27=(blocksize/2)-27;i27<(blocksize/2)-26;i27++)
	{//i27
		
	for (cl_ulong i28=(blocksize/2)-28;i28<(blocksize/2)-27;i28++)
	{//i28
							
	for (cl_ulong i29=(blocksize/2)-29;i29<(blocksize/2)-28;i29++)
	{//i29
	
	for (cl_ulong i30=(blocksize/2)-30;i30<(blocksize/2)-29;i30++)
	{//i30	
	
	for (cl_ulong i31=(blocksize/2)-31;i31<(blocksize/2)-30;i31++)
	{//i31
		
	for (cl_ulong i32=(blocksize/2)-32;i32<(blocksize/2)-31;i32++)
	{//i32
				  ...
				  //counter++;
				   ...
				   //counter++;
					...
					//counter++;
					 ...
					 for (cl_ulong i9=i8<<2;i9<blocksize;i9=i9*2)
					 {//i9*****************************************
        	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9) <= maxHam  )
        	  				{
					 ...
					 ///cout << hex <<  inputData[counter] << "\t";
					 //counter++;
					   for (cl_ulong i10=i9<<2;i10<blocksize;i10=i10*2)
					   {//i10*****************************************
       	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10) <= maxHam  )
       	  				{
					   ...
					   ///cout << hex <<  inputData[counter] << "\t";
					   //counter++;
  						for (cl_ulong i11=i10<<2;i11<blocksize;i11=i11*2)
						{//i11******************************************
         	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11) <= maxHam  )
         	  				{
						...
						///cout << hex <<  inputData[counter] << "\t";
						//counter++;
						 for (cl_ulong i12=i11<<2;i12<blocksize;i12=i12*2)
					      {//i12*****************************************
           	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12) <= maxHam  )
           	  				{
						  ...
						  ///cout << hex <<  inputData[counter] << "\t";
						  //counter++;
						    for (cl_ulong i13=i12<<2;i13<blocksize;i13=i13*2)
						    {//i13******************************************
             	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13) <= maxHam  )
             	  				{
						    ...
						    ///cout << hex <<  inputData[counter] << "\t";
						    //counter++;
							  for (cl_ulong i14=i13<<2;i14<blocksize;i14=i14*2)
							  {//i14 ******************************************
                 	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14) <= maxHam  )
                 	  				{
							  ...
							  ///cout << hex <<  inputData[counter] << "\t";
							  //counter++;
							    for (cl_ulong i15=i14<<2;i15<blocksize;i15=i15*2)
							    {//i15 ******************************************
	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15) <= maxHam  )
	               	  				{
							    ...
							    ///cout << hex <<  inputData[counter] << "\t";
							    //counter++;
							      for (cl_ulong i16=i15<<2;i16<blocksize;i16=i16*2)
								  {//i16******************************************
    	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16) <= maxHam  )
    	               	  				{
								  ...
								  ///cout << hex <<  inputData[counter] << "\t";
								  //counter++;
								    for (cl_ulong i17=i16<<2;i17<blocksize;i17=i17*2)
								  	{//i17******************************************
    	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17) <= maxHam  )
    	               	  				{
    	               	  					inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17;
    	               	  					counter++;
    	               	  				}
								  	//inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17;
								  	///cout << hex <<  inputData[counter] << "\t";
								  	//counter++;
									   //i18******************************************
								       for (cl_ulong i18=i17<<2;i18<blocksize;i18=i18*2)
								  	   {
       	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18) <= maxHam  )
       	               	  				{
       	               	  					inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18;
       	               	  					counter++;
       	               	  				}
								  	   //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18;
								  	   ///cout << hex <<  inputData[counter] << "\t";
								  	   //counter++;
									     //i19******************************************
								         for (cl_ulong i19=i18<<2;i19<blocksize;i19=i19*2)
								  	     {
	        	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19) <= maxHam  )
	        	               	  				{
	        	               	  					inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19;
	        	               	  					counter++;
	        	               	  				}
								  	     //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19;
								  	     ///cout << hex <<  inputData[counter] << "\t";
								  	     //counter++;
									       //i20******************************************
								           for (cl_ulong i20=i19<<2;i20<blocksize;i20=i20*2)
								  	       {
        	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20) <= maxHam  )
        	               	  				{
        	               	  					inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20;
        	               	  					counter++;
        	               	  				}
								  	       //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20;
								  	       ///cout << hex <<  inputData[counter] << "\t";
								  	       //counter++;
									         //i21******************************************
								             for (cl_ulong i21=i20<<2;i21<blocksize;i21=i21*2)
								  	         {
	         	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21) <= maxHam  )
	         	               	  				{
	         	               	  					inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21;
	         	               	  					counter++;
	         	               	  				}
								  	         //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21;
								  	         ///cout << hex <<  inputData[counter] << "\t";
								  	         //counter++;
									           //i22******************************************
								               for (cl_ulong i22=i21<<2;i22<blocksize;i22=i22*2)
								  	           {
   	         	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22) <= maxHam  )
   	         	               	  				{
   	         	               	  					inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22;
   	         	               	  					counter++;
   	         	               	  				}
								  	          // inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22;
								  	           ///cout << hex <<  inputData[counter] << "\t";
								  	          // counter++;
									             //i23******************************************
								                 for (cl_ulong i23=i22<<2;i23<blocksize;i23=i23*2)
								  	             {
	    	         	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23) <= maxHam  )
	    	         	               	  				{
	    	         	               	  					inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23;
	    	         	               	  					counter++;
	    	         	               	  				}
								  	             //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23;
								  	             ///cout << hex <<  inputData[counter] << "\t";
								  	             //counter++;
									               //i24******************************************
								                   for (cl_ulong i24=i23<<2;i24<blocksize;i24=i24*2)
								  	               {
    	         	               	  				if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24) <= maxHam  )
    	         	               	  				{
    	         	               	  					inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
    	         	               	  					counter++;
    	         	               	  				}
								  	               //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
								  	               ///cout << hex <<  inputData[counter] << "\t";
								  	               //counter++;
 									                 ...
 									                 //i25******************************************
 								                     for (cl_ulong i25=i24<<2;i25<blocksize;i25=i25*2)
 								  	                 {
     	         	               	  				   if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25) <= maxHam  )
     	         	               	  				  {
     	         	               	  					inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25;
     	         	               	  					counter++;
     	         	               	  				  }
 								  	                  //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
 								  	                  ///cout << hex <<  inputData[counter] << "\t";
  									                   ...
  									                   //i26******************************************
  								                       for (cl_ulong i26=i25<<2;i26<blocksize;i26=i26*2)
  								  	                   {
      	         	               	  				     if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26) <= maxHam  )
      	         	               	  				     {
      	         	               	  					 inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26;
      	         	               	  					 counter++;
      	         	               	  				     }
  								  	                     //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
  								  	                     ///cout << hex <<  inputData[counter] << "\t";
    									                   ...
    									                   //i27******************************************
    								                       for (cl_ulong i27=i26<<2;i27<blocksize;i27=i27*2)
    								  	                   {
        	         	               	  				     if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27) <= maxHam  )
        	         	               	  				     {
        	         	               	  					 inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27;
        	         	               	  					 counter++;
        	         	               	  				     }
    								  	                     //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
    								  	                     ///cout << hex <<  inputData[counter] << "\t";
    								  	                     //counter++;
      									                      ...
      									                      //i28******************************************
      								                          for (cl_ulong i28=i27<<2;i28<blocksize;i28=i28*2)
      								  	                      {
          	         	               	  				       if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28) <= maxHam  )
          	         	               	  				       {
          	         	               	  					    inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28;
          	         	               	  					    counter++;
          	         	               	  				       }
      								  	                       //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
      								  	                       ///cout << hex <<  inputData[counter] << "\t";
       									                        ...
       									                        //i29******************************************
       								                            for (cl_ulong i29=i28<<2;i29<blocksize;i29=i29*2)
       								  	                        {
           	         	               	  				         if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28^i29) <= maxHam  )
           	         	               	  				         {
           	         	               	  					      inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28^i29;
           	         	               	  					      counter++;
           	         	               	  				         }
       								  	                         //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
       								  	                         ///cout << hex <<  inputData[counter] << "\t";
       								  	                         //counter++;
        									                        //i30******************************************
        								                            for (cl_ulong i30=i29<<2;i30<blocksize;i30=i30*2)
        								  	                        {
            	         	               	  				         if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28^i29^i30) <= maxHam  )
            	         	               	  				         {
            	         	               	  					      inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28^i29^i30;
            	         	               	  					      counter++;
            	         	               	  				         }
        								  	                         //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
        								  	                         ///cout << hex <<  inputData[counter] << "\t";
        								  	                         //counter++;
         									                           //i31******************************************
         								                               for (cl_ulong i31=i30<<2;i31<blocksize;i31=i31*2)
         								  	                           {
             	         	               	  				             if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28^i29^i30^i31) <= maxHam  )
             	         	               	  				             {
             	         	               	  					          inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28^i29^i30^i31;
             	         	               	  					          counter++;
             	         	               	  				             }
         								  	                             //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
         								  	                             ///cout << hex <<  inputData[counter] << "\t";
         								  	                             //counter++;
           									                              //i32******************************************
           								                                  for (cl_ulong i32=i31<<2;i32<blocksize;i32=i32*2)
           								  	                              {
               	         	               	  				                if ( hammingWeight(i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28^i29^i30^i31^i32) <= maxHam  )
               	         	               	  				                {
               	         	               	  					             inputData[counter] = i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24^i25^i26^i27^i28^i29^i30^i31^i32;
               	         	               	  					             counter++;
               	         	               	  				                }
           								  	                                //inputData[counter] =  i1^i2^i3^i4^i5^i6^i7^i8^i9^i10^i11^i12^i13^i14^i15^i16^i17^i18^i19^i20^i21^i22^i23^i24;
           								  	                                ///cout << hex <<  inputData[counter] << "\t";
