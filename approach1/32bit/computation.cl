...
{
    //==============================PRE-WORK & CHECKS================================================
    //size_t lid1 = get_local_id(0);//get workgroup number
	//size_t lid2 = get_local_id(1);//get workgroup number
    size_t gidDim1 = get_global_id(0); // work item number
    size_t gidDim2 = get_global_id(1); // work item number
	//size_t workid1 = get_group_id(0);
    
    
    //uper bound
	if ( (gidDim1 > 1597) || (gidDim2 > 1597))
	{
