...
// ERROR DOESNT TAKE LONGEST TRAIL INTO A ACCOUNT!!!
...
for(__private ulong round=1; round <= nrRounds; round++)
{
    ...
    for (__private ulong k =0 ; k <= round ; k++ )
    {
        ...
        {
            //do nothing
			// 0 (round 1) + 0 (round 1) cant result into one round ( 1+1 =2)
        }
        
        //Check if Backward is set to round 0 (round 1)
        else if(a==0)
        {
                                        ...
                                        )
{
	...
	/*
    if ( (gidDim1 > 70000) || (gidDim2 > 70000)    ) 
    {
