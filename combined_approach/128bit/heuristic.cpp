...
void::heuristic_lib::Heuristic::runCipher()
{
	...
	cl_ulong blocksize = 64; 	        //Inner loop - pre-generated for the 28 bits
	...
	for (cl_ulong i49=blocksize-49;i49<blocksize-48;i49++)
	{//i49
	
	for (cl_ulong i50=blocksize-50;i50<blocksize-49;i50++)
	{//i50
	
	for (cl_ulong i51=blocksize-51;i51<blocksize-50;i51++)
	{//i51
	
	for (cl_ulong i52=blocksize-52;i52<blocksize-51;i52++)
	{//i52
	
	for (cl_ulong i53=blocksize-53;i53<blocksize-52;i53++)
	{//i53
	
	for (cl_ulong i54=blocksize-54;i54<blocksize-53;i54++)
	{//i54
	
	for (cl_ulong i55=blocksize-55;i55<blocksize-54;i55++)
	{//i55
	
	for (cl_ulong i56=blocksize-56;i56<blocksize-55;i56++)
	{//i56
	
	for (cl_ulong i57=blocksize-57;i57<blocksize-56;i57++)
	{//i57
	
	for (cl_ulong i58=blocksize-58;i58<blocksize-57;i58++)
	{//i58
	
	for (cl_ulong i59=blocksize-59;i59<blocksize-58;i59++)
	{//i59
	
	for (cl_ulong i60=blocksize-60;i60<blocksize-59;i60++)
	{//i60
	
	for (cl_ulong i61=blocksize-61;i61<blocksize-60;i61++)
	{//i61
	
	for (cl_ulong i62=blocksize-62;i62<blocksize-61;i62++)
	{//i62
	
	for (cl_ulong i63=blocksize-63;i63<blocksize-62;i63++)
	{//i63
	
	for (cl_ulong i64=blocksize-64;i64<blocksize-63;i64++)
	{//i64
		...
		*/
		...
		inputData[counter] =getHexBit64[i49];
		counter++;

		inputData[counter] =getHexBit64[i50];
		counter++;
		
		inputData[counter] =getHexBit64[i51];
		counter++;

		inputData[counter] =getHexBit64[i52];
		counter++;

		inputData[counter] =getHexBit64[i53];
		counter++;

		inputData[counter] =getHexBit64[i54];
		counter++;
		
		inputData[counter] =getHexBit64[i55];
		counter++;

		inputData[counter] =getHexBit64[i56];
		counter++;

		inputData[counter] =getHexBit64[i57];
		counter++;

		inputData[counter] =getHexBit64[i58];
		counter++;
		
		inputData[counter] =getHexBit64[i59];
		counter++;

		inputData[counter] =getHexBit64[i60];
		counter++;

		inputData[counter] =getHexBit64[i61];
		counter++;
		
		inputData[counter] =getHexBit64[i62];
		counter++;

		inputData[counter] =getHexBit64[i63];
		counter++;

		inputData[counter] =getHexBit64[i64];
		counter++;
		...
		*/
		...
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i49];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i50];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i51];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i52];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i53];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i1]^getHexBit64[i64];
		counter++;
		...
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i49];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i50];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i51];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i52];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i53];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i2]^getHexBit64[i64];
		counter++;
		...
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i49];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i50];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i51];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i52];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i53];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i3]^getHexBit64[i64];
		counter++;
		...
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i49];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i50];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i51];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i52];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i53];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i4]^getHexBit64[i64];
		counter++;
		...
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i49];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i50];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i51];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i52];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i53];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i5]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[
^getHexBit64[i51];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i52];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i53];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i49]^getHexBit64[i64];
		counter++;
		
		//i50
		inputData[counter] =getHexBit64[i50]^getHexBit64[i51];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i52];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i53];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i50]^getHexBit64[i64];
		counter++;
		
		//i51
		inputData[counter] =getHexBit64[i51]^getHexBit64[i52];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i53];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i51]^getHexBit64[i64];
		counter++;
		
		//i52
		inputData[counter] =getHexBit64[i52]^getHexBit64[i53];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i52]^getHexBit64[i64];
		counter++;
		
		//i53
		inputData[counter] =getHexBit64[i53]^getHexBit64[i54];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i53]^getHexBit64[i64];
		counter++;
		
		//i54
		inputData[counter] =getHexBit64[i54]^getHexBit64[i55];
		counter++;
		inputData[counter] =getHexBit64[i54]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i54]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i54]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i54]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i54]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i54]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i54]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i54]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i54]^getHexBit64[i64];
		counter++;
		
		//i55
		inputData[counter] =getHexBit64[i55]^getHexBit64[i56];
		counter++;
		inputData[counter] =getHexBit64[i55]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i55]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i55]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i55]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i55]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i55]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i55]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i55]^getHexBit64[i64];
		counter++;
		
		//i56
		inputData[counter] =getHexBit64[i56]^getHexBit64[i57];
		counter++;
		inputData[counter] =getHexBit64[i56]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i56]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i56]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i56]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i56]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i56]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i56]^getHexBit64[i64];
		counter++;
		
		//i57
		inputData[counter] =getHexBit64[i57]^getHexBit64[i58];
		counter++;
		inputData[counter] =getHexBit64[i57]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i57]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i57]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i57]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i57]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i57]^getHexBit64[i64];
		counter++;
		
		//i58
		inputData[counter] =getHexBit64[i58]^getHexBit64[i59];
		counter++;
		inputData[counter] =getHexBit64[i58]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i58]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i58]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i58]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i58]^getHexBit64[i64];
		counter++;
		
		//i59
		inputData[counter] =getHexBit64[i59]^getHexBit64[i60];
		counter++;
		inputData[counter] =getHexBit64[i59]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i59]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i59]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i59]^getHexBit64[i64];
		counter++;
		
		//i60
		inputData[counter] =getHexBit64[i60]^getHexBit64[i61];
		counter++;
		inputData[counter] =getHexBit64[i60]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i60]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i60]^getHexBit64[i64];
		counter++;
		
		//i61
		inputData[counter] =getHexBit64[i61]^getHexBit64[i62];
		counter++;
		inputData[counter] =getHexBit64[i61]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i61]^getHexBit64[i64];
		counter++;
		
		//i62
		inputData[counter] =getHexBit64[i62]^getHexBit64[i63];
		counter++;
		inputData[counter] =getHexBit64[i62]^getHexBit64[i64];
		counter++;
		
		//i63
		inputData[counter] =getHexBit64[i63]^getHexBit64[i64];
		counter++;
